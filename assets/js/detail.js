...
fetchData(null, data =>{
    ...
    ingrediantLines.map(ingrediant =>{
        ingrediantItems += `
        <li class="ingr-item">${ingrediant}</li>
        `
    });
...
<div class="detail-content">
    ...
    <div class="detail-stats">
        <div class="stats-item">
            <span class="display-medium">${ingrediants.length}</span>
    ...
    ${ingrediantItems ? `<ul class="body-large ingr-list">${ingrediantItems}</ul>` : ""}
</div>
    `
})